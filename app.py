...
st.set_page_config(
    ...
    menu_items={
        'Get Help': 'https://www.linkedin.com/in/kadi-ajay-106854259/',
        'Report a bug': "https://github.com/KadiAjay",
...
with st.sidebar:
    selected = option_menu(
        ...
        options=["Home", "Recommendations", "Generate Report", "Chat With Me", "WorkFlow"],
        icons=["house", "magic", "book", "chat", "activity"],
